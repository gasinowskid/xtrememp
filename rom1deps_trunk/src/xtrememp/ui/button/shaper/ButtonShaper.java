...
public abstract class ButtonShaper implements SubstanceButtonShaper {
    ...
    public Shape getButtonOutline(AbstractButton button) {
		return getButtonOutline(button, null, button.getWidth(), button.getHeight(), false);
    }

    @Override
    public Shape getButtonOutline(AbstractButton button, Insets insets) {
        return getButtonOutline(button, insets, button.getWidth(), button.getHeight(), false);
    }

    @Override
    public Shape getButtonOutline(AbstractButton button, Insets insets, int width, int height) {
        return getButtonOutline(button, insets, width, height, false);
    }
