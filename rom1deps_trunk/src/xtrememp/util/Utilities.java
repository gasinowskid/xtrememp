...
public final class Utilities {
    ...
    //
    private static final String imgPath = "/xtrememp/resources/images/";
    ...
    public static List<Image> getIconImages() {
        ...
        try {
            icons.add(ImageIO.read(Utilities.class.getResourceAsStream(imgPath.concat("icon_32.png"))));
            icons.add(ImageIO.read(Utilities.class.getResourceAsStream(imgPath.concat("icon_48.png"))));
            icons.add(ImageIO.read(Utilities.class.getResourceAsStream(imgPath.concat("icon_64.png"))));
    ...
    public static Icon getIcon(String name) {
        ...
        if (name != null) {
            try {
                icon = new ImageIcon(ImageIO.read(Utilities.class.getResourceAsStream(imgPath.concat(name))));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
    ...
    public static BufferedImage getImage(String name) {
        ...
        if (name != null) {
            try {
                image = ImageIO.read(Utilities.class.getResourceAsStream(imgPath.concat(name)));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
