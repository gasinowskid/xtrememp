...
/**
 * Playlist item genre comparator.
 *
 * @author Besmir Beqiri
 */
public class GenreComparator implements Comparator<PlaylistItem> {
    ...
    public int compare(PlaylistItem pli1, PlaylistItem pli2) {
        ...
        return tg1.getGenre().compareTo(tg2.getGenre());
    }
    ...
    public boolean equals(Object obj) {
        return (this == obj)
                || ((obj != null) && (obj instanceof GenreComparator));
    }
}
