...
/**
 * Playlist item title comparator.
 *
 * @author Besmir Beqiri
 */
public class TitleComparator implements Comparator<PlaylistItem> {
    ...
    public int compare(PlaylistItem pli1, PlaylistItem pli2) {
        ...
        return tg1.getTitle().compareTo(tg2.getTitle());
    }
    ...
    public boolean equals(Object obj) {
        return (this == obj)
                || ((obj != null) && (obj instanceof TitleComparator));
    }
}
